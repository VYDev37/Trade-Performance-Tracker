...
export default function NoteForm({ existingData, loading, error, onSubmit }: NoteFormProps) {
    ...
    return (
        <form onSubmit={(e) => {
            ...
            {error && (
                <div className="mx-5 p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-destructive text-sm text-center">
                    {error}
                </div>
            )}
            <div className="mx-5">
